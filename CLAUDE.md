...
This file provides guidance to Claude Code (claude.ai/code) when working with code in this repository. But also to you, the human, if you contribute skills.
